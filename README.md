...
| [tesser_fractal](https://github.com/AdrianArtacho/tesser_fractal.git) | This Patch is part of the [TESSER environment](https://bitbucket.org/AdrianArtacho/tesserakt/src/master/). | – |
...
| [tesser_gate](https://github.com/AdrianArtacho/tesser_gate.git) | This Patch is part of the [TESSER environment](https://bitbucket.org/AdrianArtacho/tesserakt/src/master/). | – |
| [tesser_gesture](https://github.com/AdrianArtacho/tesser_gesture.git) | This Patch is part of the [TESSER environment](https://bitbucket.org/AdrianArtacho/tesserakt/src/master/). | – |
...
| [tesser_mirror](https://github.com/AdrianArtacho/tesser_mirror.git) | This Patch is part of the [TESSER environment](https://bitbucket.org/AdrianArtacho/tesserakt/src/master/). | – |
...
| [tesser_note2cc](https://github.com/AdrianArtacho/tesser_note2cc.git) | This Patch is part of the [TESSER environment](https://bitbucket.org/AdrianArtacho/tesserakt/src/master/). | – |
...
| [tesser_pgch](https://github.com/AdrianArtacho/tesser_pgch.git) | This Patch is part of the [TESSER environment](https://bitbucket.org/AdrianArtacho/tesserakt/src/master/). | – |
...
| [tesser_prompt](https://github.com/AdrianArtacho/tesser_prompt.git) | This M4L device displays dialogs with prompts to the performer. | – |
...
| [tesser_scale](https://github.com/AdrianArtacho/tesser_scale.git) | This Patch is part of the [TESSER environment](https://bitbucket.org/AdrianArtacho/tesserakt/src/master/). | – |
