...
//////////////////////////////////////////		
		...
		rectangle(22, Math.floor(span/3), width-44, span-Math.floor(span/3)*2);
		fill();
//////////////////////////////////////////
		if (idl == 0){
		...
		rectangle(center-(width-44)*percentage/200, 1, (width-44)*percentage/100., span-2);
		fill();
		set_line_width(0.5);
		if (idl == 0){
		set_source_rgba(bordercolorh);
...
//////////////////////////////////////////		
		...
		rectangle(Math.floor(span/3), 22, span-Math.floor(span/3)*2, height-44);
		fill();
//////////////////////////////////////////
		if (idl == 0){
		set_source_rgba(bodycolorh);
		...
		rectangle( 1, center-(height-44)*percentage/200, span-2, (height-44)*percentage/100.);
		fill();
		set_line_width(0.5);
		if (idl == 0){
		set_source_rgba(bordercolorh);
...
function onclick(x,y,but,cmd,shift,capslock,option,ctrl)
{
	...
	idl = 0;
/*
if (position< center-(width-44)*percentage/200 || position>center+((width-44)*percentage/100.)/2.){
...
function ondrag(x,y,but,cmd,shift,capslock,option,ctrl)
{
	...
	idl = 0;
if (position>(extent-22)*percentage/200+19 && position<=extent-((extent-22)*percentage/200+20)){
	if (position>=center-(extent-44)*percentage/200 && position<=center+((extent-44)*percentage/100./2.)){
		center = center+(position-last_position);
		}
		else{
		center = position;
		}
